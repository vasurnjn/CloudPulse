...
from analytics.metrics_analyzer import get_average_cpu, get_max_cpu, get_total_records, get_min_cpu, get_average_memory, get_average_disk, get_max_memory, get_max_disk, get_min_memory, get_min_disk
...
while True:
    ...
    display_metrics(metrics, average_cpu, max_cpu, total_records, min_cpu, average_memory, max_memory, min_memory, average_disk, max_disk, min_disk,logs)
    time.sleep(10)