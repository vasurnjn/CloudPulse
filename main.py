...
from database.db_manager import init_database,save_metrics,save_logs
...
from analytics.metrics_analyzer import get_average_cpu, get_latest_logs, get_max_cpu, get_total_records, get_min_cpu, get_average_memory, get_average_disk, get_max_memory, get_max_disk, get_min_memory, get_min_disk, get_latest_logs
...
while True:
    ...
    display_metrics(metrics, average_cpu, max_cpu, total_records, min_cpu, average_memory, max_memory, min_memory, average_disk, max_disk, min_disk,latest_logs)
    time.sleep(10)